...
namespace paulocesar2.Controllers
{
    public class TransportadorasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,IdTransportadora,Nome")] Transportadora transportadora)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdTransportadora,Nome")] Transportadora transportadora)
        {
