...
namespace paulocesar2.Controllers
{
    public class VendedorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,IdVendedor,Nome")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdVendedor,Nome")] Vendedor vendedor)
        {
            if (id != vendedor.Id)
            {
                return NotFound();
