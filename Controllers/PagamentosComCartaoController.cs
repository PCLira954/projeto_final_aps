...
namespace paulocesar2.Controllers
{
    public class PagamentosComCartaoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("NumeroDoCartao,Bandeira,Id,IdTipoPagamento,NomeDoCobrado,InformacoesAdicionais")] PagamentoComCartao pagamentoComCartao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NumeroDoCartao,Bandeira,Id,IdTipoPagamento,NomeDoCobrado,InformacoesAdicionais")] PagamentoComCartao pagamentoComCartao)
        {
