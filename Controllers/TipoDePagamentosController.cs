...
namespace paulocesar2.Controllers
{
    public class TipoDePagamentosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,IdTipoPagamento,NomeDoCobrado,InformacoesAdicionais")] TipoDePagamento tipoDePagamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdTipoPagamento,NomeDoCobrado,InformacoesAdicionais")] TipoDePagamento tipoDePagamento)
        {
