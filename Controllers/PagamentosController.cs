...
namespace paulocesar2.Controllers
{
    public class PagamentosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,IdPagamento,DataLimite,Valor,Pago")] Pagamento pagamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdPagamento,DataLimite,Valor,Pago")] Pagamento pagamento)
        {
            if (id != pagamento.Id)
            {
                return NotFound();
